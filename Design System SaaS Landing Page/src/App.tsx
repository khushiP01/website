...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-purple-950 to-purple-900 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-violet-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }} />
